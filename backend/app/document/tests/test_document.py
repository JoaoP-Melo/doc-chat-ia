...
def test_delete_file_success(
    ...
    response = client_override.delete(
        "document/delete_file/", params={"document_id": int(add_document_in_db.id)}
    )
...
def test_delete_file_success(
    ...
    response = client_override.delete(
        "document/delete_file/", params={"document_id": int(add_document_in_db.id) - 1}
    )
...
def test_read_file_success(
    ...
    response = client_override.get("document/read_file/")
